...
export default function Services(){
    return(
        <div className="relative w-full h-auto bg-left  bg-cover  lg:bg-contain bg-no-repeat " style={{ backgroundImage: `url(${bgImage})` }}>
            <div className="lg:mx-24 lg:mb-12  mx-20 mb-10 "  >
                ...
                <div className="grid bg-transparent md:gap-x-14 gap-y-10  grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 lg:mb-12  mb-14">
